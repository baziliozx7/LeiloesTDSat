...
public class cadastroVIEW extends javax.swing.JFrame {
    ...
    try {
        ...
        if (nome.isEmpty() || valorTexto.isEmpty()) {
            JOptionPane.showMessageDialog(null, "Por favor, preencha todos os campos!", "Erro de Preenchimento", JOptionPane.ERROR_MESSAGE);
            return;
        }
        int valor = 0;
         ...
         try {
            ...
            JOptionPane.showMessageDialog(null, "Valor inválido! Insira apenas números.", "Erro de Formatação", JOptionPane.ERROR_MESSAGE);
            return;
        }
